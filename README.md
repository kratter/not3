...
| M3 — lens engine + starter lenses | done |
| M4 — Tauri + React desktop UI | done |
| M5 — speaker diarization | done |
| M6 — packaging and installers | done |
| M7 — cross-note insights, search, lens lab & sample library | done |
...
Not3 is built entirely on the shoulders of remarkable open-source engineering, open-weights machine learning, and foundational cognitive science research:

### 🎙️ Speech Recognition & Audio Processing
* **[whisper.cpp](https://github.com/ggml-org/whisper.cpp)** by **Georgi Gerganov & contributors** — High-performance C/C++ port of OpenAI's Whisper model enabling CUDA, Metal, and AVX2-accelerated inference.
* **[OpenAI Whisper](https://github.com/openai/whisper)** — Open-weights automatic speech recognition models (`large-v3`, `large-v3-turbo`).
* **[Silero VAD](https://github.com/snakers4/silero-vad)** by **Silero Team** — Pre-trained enterprise-grade Voice Activity Detector providing millisecond-accurate speech boundary detection.
* **[Sherpa-ONNX](https://github.com/k2-fsa/sherpa-onnx)** by **Next-gen Kaldi project (Daniel Povey, Fangjun Kuang & contributors)** — Offline speech and speaker diarization engine using ONNX Runtime.
* **[PyAnnote.audio](https://github.com/pyannote/pyannote-audio)** & **[WeSpeaker](https://github.com/wenet-e2e/wespeaker)** — Pre-trained speaker segmentation (PyAnnote 3.0) and speaker embedding models (CAM++ VoxCeleb).

### 🧠 Local Language Models & Runtime
* **[Ollama](https://ollama.com/)** by the **Ollama Team** — Lightweight, high-performance local LLM execution runtime.
* **[Qwen Models](https://github.com/QwenLM/Qwen2.5)** by **Alibaba Cloud Qwen Team** — State-of-the-art open-weights language models (`qwen3.5:9b`, `qwen2.5`) powering structured extraction, report distillation, and pattern lenses.

### 🖥️ Desktop Shell & Systems Infrastructure
* **[Tauri](https://tauri.app/)** by the **Tauri Apps Team** — Native, memory-safe desktop application framework for Rust and Webview.
* **[FastAPI](https://fastapi.tiangolo.com/) & [Pydantic](https://docs.pydantic.dev/)** by **Sebastián Ramírez & contributors** — Modern asynchronous API routing and strict schema enforcement.
* **[RapidFuzz](https://github.com/rapidfuzz/RapidFuzz)** by **Max Bachmann** — Ultra-fast C++ string distance engine powering the verbatim quote anchoring gate.
* **[SQLite](https://sqlite.org/)** by **D. Richard Hipp & contributors** — Embedded, bulletproof relational and full-text search database.

### 📚 Psychological & Behavioral Science Frameworks
The diagnostic lenses in Not3 are grounded in established clinical, behavioral, and communication science research:
* **Cognitive Behavioral Therapy (CBT)**: Cognitive distortions framework pioneered by **Aaron T. Beck, M.D.** and popularized by **David D. Burns, M.D.**
* **Psychological Defense Mechanisms**: Ego defense classifications developed by **Sigmund Freud** and systematized by **Anna Freud**.
* **Behavioral Economics & Heuristics**: Cognitive decision biases identified by **Daniel Kahneman & Amos Tversky** (*Thinking, Fast and Slow*).
* **Motivational Interviewing (MI)**: Linguistic markers of change talk and ambivalence formulated by **William R. Miller, Ph.D. & Stephen Rollnick, Ph.D.**
* **Interpersonal Conflict Dynamics**: Escalation bids, stonewalling, and relational patterns researched by **John M. Gottman, Ph.D. & Julie Schwartz Gottman, Ph.D.** (The Gottman Institute).
* **Person-Centered Communication**: Reflective listening, active empathy, and non-defensive inquiry developed by **Carl R. Rogers, Ph.D.**

---
*All psychological and communication observations generated by Not3 are linguistic pattern descriptions anchored to verbatim speech and do not constitute clinical diagnosis or medical assessment.*
